    ...
    <>
      ...
      <main className={`${style.home_news_kr} container`}>
        ...
        <div className={style.row_7}>
          ...
          <HomeBannerChanner title1='리딩게이트' title2='공식 Instagram' linkTxt1='다양한 소식 모아보기' link1='https://www.instagram.com/readinggate_official/' bgColor='#BF2024' bgImage='/src/images/@home/channer/channer_insta.svg' />
